...
var CLICK_AUTO_ON_COMPLETE = true;
var AUTO_CLICK_DELAY = 0;
var ADVANCE_ONE_GENERATION_BEFORE_AUTO_CLICK = false;
var selectorStrings = {
...
var selectors = {
  ...
  autoPlay: function autoPlay() {
    return document.querySelector(selectorStrings.autoPlay);
  }
};
...
var isValidPoint = function isValidPoint(_ref3, gameBoard) {
  var _ref4 = _slicedToArray(_ref3, 2),
    x = _ref4[0],
    y = _ref4[1];
  return Boolean(x >= 0 && x < gameBoard.length && y >= 0 && y < gameBoard[0].length);
};
...
var getSliderValues = function getSliderValues(range) {
  return {
    value: getFrac(range, range.value),
    output: getOutputVal(range.value)
  };
};
var handleSaveViaAutoPlay = function handleSaveViaAutoPlay(nextGeneration) {
  setTimeout(function () {
...
var setGenerations = function setGenerations() {
  ...
  var slider = getSliderValues(range);
